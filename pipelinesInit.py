...
try:
    ...
    import dummy_pt_objects  # noqa F403
...
try:
    if not (is_torch_available() and is_librosa_available()):
     ...
     import dummytorchandlibrosaobjects  # noqa F403

    _dummy_objects.update(get_objects_from_module(dummytorchandlibrosaobjects))
else:
...
try:
    if not (is_transformers_available() and is_torch_available() and is_note_seq_available()):
     ...
     import dummytransformersandtorchandnoteseqobjects  # noqa F403

    _dummy_objects.update(get_objects_from_module(dummytransformersandtorchandnoteseqobjects))
else:
    _import_structure["deprecated"].extend(
        [
            "MidiProcessor",
...
try:
    ...
    import dummytorchandtransformersobjects  # noqa F403

    _dummy_objects.update(get_objects_from_module(dummytorchandtransformersobjects))
else:
    _import_structure["deprecated"].extend(
        [
            "VQDiffusionPipeline",
...
try:
    ...
    import dummy_onnx_objects  # noqa F403
...
try:
    ...
    import dummy_torch_and_transformers_and_onnx_objects  # noqa F403
...
try:
    ...
    import dummytorchandtransformersandkdiffusionobjects,
    

    _dummy_objects.update(get_objects_from_module(dummytorchandtransformersandkdiffusionobjects))
else:
...
try:
    ...
    import dummyflaxobjects  # noqa F403

    _dummy_objects.update(get_objects_from_module(dummyflaxobjects))
else:
...
try:
    ...
    import dummyflaxandtransformersobjects  # noqa F403

    _dummy_objects.update(get_objects_from_module(dummyflaxandtransformersobjects))
else:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        import dummytorchandlibrosaobjects 
    else:
    ...
    try:
        ...
        import dummytorchandtransformersobjects 
    else:
